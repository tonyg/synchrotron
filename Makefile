INDEX_MODFILES=demomod io jquery-1.6.2.min module boot_new boot_old sha1 objmem mc diff json2 graph showdown panels knockout-1.2.1 codemirror codemirror-javascript
INDEX_STYLES=synchrotron.css panels.css codemirror.css codemirror-theme-default.css
